...
const Modal = (props) => {
	...
	return (
		<>
			...
			<ChakraModal size={size} preserveScrollBarGap={true} isOpen={disclosure.isOpen} onClose={disclosure.onClose} {...props}>
				<style jsx global>{`
					::-webkit-scrollbar {
						display: none;
					}
				...
				<ModalContent>
					{(!header || header !== 'off') && (
						<ModalHeader display="flex" justifyContent="space-between" alignItems="center">
							...
							<IconButton variant="tinted" size="sm" borderRadius="full" icon={<FiX size={16} />} onClick={disclosure.onClose} />
						</ModalHeader>
					)}
