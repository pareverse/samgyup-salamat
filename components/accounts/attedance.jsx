...
import { Avatar, Badge, Button, Flex, IconButton, Input, Td, Text, Tr } from '@chakra-ui/react'
		...
		<Card>
			<Flex direction="column" gap={6}>
				<Table
					...
					filters={(data, watch) => {
						return data.filter((data) => (watch('date') ? convert(watch('date')) === data.date && data.user === user._id : data.user === user._id))
					}}
