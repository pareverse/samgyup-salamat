					...
					<Flex justify="space-between" align="center">
						<Flex direction="column" gap={1} w="calc(100% - 76px)">
							...
							<Text fontSize="sm" fontWeight="medium" color="accent-1">
								{date !== today ? 'Total' : null} Present {date === today ? 'Today' : null}
							</Text>
						</Flex>
				...
				<Card>
					<Flex justify="space-between" align="center">
						<Flex direction="column" gap={1} w="calc(100% - 76px)">
							...
							<Text fontSize="sm" fontWeight="medium" color="accent-1">
								{date !== today ? 'Total' : null} Absent {date === today ? 'Today' : null}
							</Text>
						</Flex>
				...
				<Card>
					<Flex justify="space-between" align="center">
						<Flex direction="column" gap={1} w="calc(100% - 76px)">
							...
							<Text fontSize="sm" fontWeight="medium" color="accent-1">
								{date !== today ? 'Total' : null} Percentage {date === today ? 'Today' : null}
							</Text>
						</Flex>
