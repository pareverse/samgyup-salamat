...
const Table = (props) => {
	const { data, fetched, th, td, controls, filters, effects, settings } = props
	...
	return (
		<Flex direction="column" gap={6}>
			<Flex display={xsettings.search === 'off' && !controls ? 'none' : 'flex'} direction={{ base: 'column', md: 'row' }} gap={3}>
