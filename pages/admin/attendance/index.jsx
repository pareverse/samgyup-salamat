...
import { Avatar, Badge, Button, Container, Flex, IconButton, Input, Td, Text, Tr } from '@chakra-ui/react'
					...
					<Table
						...
						controls={(register) => (
							<Flex flex={1} justify="end" align="center" gap={3}>
								...
								<Button size="lg" colorScheme="brand" onClick={() => window.open(`${process.env.NEXT_PUBLIC_URL}/admin/attendance/today`, 'attendance', 'width=1366, height=768')}>
									Add New
								</Button>
							</Flex>
						)}
						filters={(data, watch) => {
							return data.filter((data) => (watch('date') ? convert(watch('date')) === data.date : data))
						}}
