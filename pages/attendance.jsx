...
import { Avatar, Badge, Container, Flex, IconButton, Input, Td, Text, Tr } from '@chakra-ui/react'
			...
			<Flex direction="column" gap={6}>
				...
				<Card>
					<Table
						...
						filters={(data, watch) => {
							return data.filter((data) => data.user === session.user.id).filter((data) => (watch('date') ? convert(watch('date')) === data.date : data))
						}}
